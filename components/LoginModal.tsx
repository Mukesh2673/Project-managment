...
export default function LoginModal({ isOpen, onClose, onSwitchToSignup }: LoginModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-md shadow-2xl border border-gray-200 dark:border-slate-700 animate-scale-in"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-5 bg-white dark:bg-slate-900">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <button
              type="button"
